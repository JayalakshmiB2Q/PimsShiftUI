<%@ Page Title="" Language="C#" MasterPageFile="~/Superviser.Master" AutoEventWireup="true" CodeBehind="SupervisorMainDashboard.aspx.cs" Inherits="ProclainPIMSMaster.Form.SupervisorMainDashboard"  %>
	...
	<div class="row">
		<div class="col-md-3">
			<div class="dbox dbox--color-2">
				...
				<div class="dbox__body">					
                    <span id="count" runat="server" class="dbox__count">0</span>                    
		 ...
		 <div class="col-md-3">
			<div class="dbox dbox--color-2">
				...
				<div class="dbox__body">
				 <span id="countass" runat="server" class="dbox__count">0</span>          
					<span class="dbox__title">To Implementer</span>
				</div>
         ...
         <div class="col-md-3">
			<div class="dbox dbox--color-2">
				...
				<div class="dbox__body">
				 <span id="countotr" runat="server" class="dbox__count">0</span>          
					<span class="dbox__title">other Department</span>
				</div>
        ...
        <div class="col-md-3">
			<div class="dbox dbox--color-2">
				...
				<div class="dbox__body">
				 <span id="counthold" runat="server" class="dbox__count">0</span>          
...
<%--<script type="text/javascript">
    ...
    function bindgraphNew(EMPDBM, hod, imp, hos, ben, fin, c, cass, ccom, chol, crej, cotr, crs_h, crs_hr) {
             Barchart(EMPDBM, hod, imp, hos, ben, fin);
             Barchartman(c, cass, ccom, chol, crej, cotr, crs_h, crs_hr);
             console.log('method called ', EMPDBM, hod, imp, hos, ben, fin, c, cass, ccom, chol, crej, cotr, crs_h, crs_hr)
                                    }
