<%@ Page Title="" Language="C#" MasterPageFile="~/DBM.Master" AutoEventWireup="true" CodeBehind="DBM_Employee_Suggestion.aspx.cs" Inherits="ProclainPIMSMaster.Form.DBM_Employee_Suggestion" %>
    ...
    <div class="col-sm-2">
     ...
     <script>
         ...
         function sendEmail() {
             ...
             if (sub == "" || sub == null) {
                 alert("enter Improve Idea Form");

             }
             else if (ben == "" || ben == null) {
                 alert("enter benefits");

             }
             else if (selectedValues.length == 0) {
                 alert("select atleast one categories");

             }
             else if (beftxt == "" || beftxt == null) {
                 alert("enter before content");

             }
             else if (afttxt == "" || afttxt == null) {
                 alert("enter after content");
