<%@ Page Title="" Language="C#" MasterPageFile="~/DBM.Master" AutoEventWireup="true" CodeBehind="EmployeeAdd.aspx.cs" Inherits="ProclainPIMSMaster.Form.EmployeeAdd" %>
        ...
        <div class="row">
                ...
                <div class ="col-sm-11">
                 ...
                 <div class="col-sm-1" style="padding-left: 0px!important;padding-right: 0px!important" >
                      ...
                      <img src="../UI/assets/static/images/Icons/Add.jpg" data-toggle="modal" data-target="#myModalCompany" style="height:30px;width:30px;"/>
        ...
        <div class="container-table100 form-control" style="display: contents!important;">
            <div class="wrap">
                <div class="row">
                 ...
                 <asp:Button ID="DisableButton" CssClass="form-control btns btn-primary" Width="100%" BorderColor ="DodgerBlue" style="color:black; font-size: initial;margin-right: 5px;"  runat="server" Text="Disable Employee" OnClick="DisableButton_Click"  />
                 ...
                 $.ajax({
                    ...
                    success: function (response) {
                        ...
                        if (er != 1) {
                            ...
                            document.getElementById('<%= DDLTextBox.ClientID %>').value = response.d.Department;
                            document.getElementById('<%= DesignationDDList.ClientID %>').value = response.d.Designation;
