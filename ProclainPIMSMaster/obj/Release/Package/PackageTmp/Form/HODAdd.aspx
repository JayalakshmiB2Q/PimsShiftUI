<%@ Page Title="" Language="C#" MasterPageFile="~/DBM.Master" AutoEventWireup="true" CodeBehind="HODAdd.aspx.cs" Inherits="ProclainPIMSMaster.Form.HODAdd" %>
...
<%--<div class="col-12 peer pX-40  h-100 bgc-white scrollable pos-r" style="min-width:320px; padding-top: 28px">--%>
    ...
    <div class="col-lg-8 form-control" style="margin-left: 198px;">
         <div class="leftside no-gutters">
             <center><h4 class="text-black"><b>Employee Login Create Form</b></h4> </center>
            ...
            <div class="row ">
                ...
                <br />
                        ...
                        <div class="peers ai-c jc-sb fxw-nw">
                            ...
                            <%--<div class="peer">--%>
                                <asp:Button ID="SignUpButton" CssClass="form-control bor reps" BorderColor="DodgerBlue" style="color:white" runat="server" Text="SignUp" Width="100%" OnClick="SignUpButton_Click"  />
