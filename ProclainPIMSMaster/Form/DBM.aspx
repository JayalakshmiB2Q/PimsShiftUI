<%@ Page Title="" Language="C#" MasterPageFile="~/DBM.Master" AutoEventWireup="true" CodeBehind="DBM.aspx.cs" Inherits="ProclainPIMSMaster.Form.DBM" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
		...
		<div class="col-md-3">
			<div class="dbox dbox--color-2">
				...
				<div class="dbox__body">					
                    <span id="spanTotal" runat="server" class="dbox__count">0</span>                    
		...
		<div class="col-md-3">
			<div class="dbox dbox--color-2">
				...
				<div class="dbox__body">
					<span id="spanNew" runat="server"  class="dbox__count">0</span>
					<span class="dbox__title">Received</span>
				</div>											
			</div>
		</div>
		<div class="col-md-3">
			<div class="dbox dbox--color-2">
				...
				<div class="dbox__body">
					<span  id="spanAccepted" runat="server" class="dbox__count">0</span>
					<span class="dbox__title">Accepted</span>
				</div>											
			</div>
		</div>
        <div class="col-md-3">
			<div class="dbox dbox--color-2">
				...
				<div class="dbox__body">
		      <span id="spanNotFeas" runat="server" class="dbox__count" >0</span>
                                               
					<span class="dbox__title">Rejected</span>
				</div>								
			</div>
		</div>
        ...
        <div class="col-md-3"hidden>
			<div class="dbox dbox--color-2">
				...
				<div class="dbox__body">
				 <span id="spanImpl" runat="server" class="dbox__count">0</span>          
					<span class="dbox__title">Implemented</span>
				</div>
