...
namespace ProclainPIMSMaster.Form
{
    ...
    public partial class Man_EmployeeADD : System.Web.UI.Page
    {
        ...
        private void load()
        {
            try
            {
                if ((!IsPostBack) || (Check == 1))
                {
                    ...
                    ProclainPIMSMaster.ManagerMaster admaster = (ProclainPIMSMaster.ManagerMaster)this.Master;
        ...
        public void Insert()
        {
            ...
            try
            {
                if (EmployeeIdTextBox.Text != "" && EmployeeIdTextBox.Text != "System.Data.DataRowView")
                {
                    ...
                    Check = 1;
                    Response.Redirect("Man_EmployeeADD.aspx");
