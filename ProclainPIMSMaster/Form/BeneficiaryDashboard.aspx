                                     ...
                                     <div class="container mt-3">
                                       <ul class="nav nav-tabs">
                                        ...
                                        <li class="nav-item" id="hideassign">
                                            <a class="nav-link" data-toggle="tab" href="#assigned">Sent &nbsp;<span id="countsent" class="badge badge-pill badge-primary" runat="server">0</span></a>
                                        ...
                                        <%--<div class="pear bdB">--%>
                                           ...
                                           <div class="ideadiv" style="padding-left: 10px;">
                                            ...
                                            <div id="assigned" class="container tab-pane">
                                                 <asp:Repeater ID="MailRepeatersent" runat="server" OnItemCommand="MailRepeater_ItemCommand" > 
                                    <%-- OnItemCreated="MailRepeater_ItemCreated"  --%>
                                    <ItemTemplate>
                                        <%--<div class="pear bdB">--%>
