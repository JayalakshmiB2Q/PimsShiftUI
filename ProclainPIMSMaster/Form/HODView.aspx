<%@ Page Title="" Language="C#" MasterPageFile="~/DBM.Master" AutoEventWireup="true" CodeBehind="HODView.aspx.cs" Inherits="ProclainPIMSMaster.Form.HODView" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
    <div class="col-cmd-6 text float-md-left" style="margin-left: 1100px;">
                           
                                <asp:Button ID="SignUpButton" CssClass="form-control bor reps" BorderColor="DodgerBlue"  style="color:white" runat="server" Text="AddNew" Width="100%" OnClick="SignUpButton_Click"  />                                                                                 
                    </div>
    
    <div class=" col-lg-12 rep" >       
                <div class="limiter rep">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="table100 ver6 m-b-110 table-responsive">
                            <div class="form-control rep  " style="border: none!important;">
                                <div class="row">
