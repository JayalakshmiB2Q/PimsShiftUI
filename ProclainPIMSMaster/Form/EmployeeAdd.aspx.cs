            ...
            try
            {
                try
                {
                    if ((cmid != "") && (cmid != "System.Data.DataRowView"))
                    {
                        ...
                        tdp.Department = DS.Tables[0].Rows[0].ItemArray[1].ToString();
                        //SIDesID = DS.Tables[0].Rows[0].ItemArray[4].ToString();
                        tdp.Designation = DS.Tables[0].Rows[0].ItemArray[3].ToString();

                        tdp.DupCheck = DS.Tables[0].Rows[0].ItemArray[5].ToString();
                        tdp.Email = DS.Tables[0].Rows[0].ItemArray[6].ToString();
