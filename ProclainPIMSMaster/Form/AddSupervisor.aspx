...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="col-lg-4 form-control" >
        ...
        <br />
            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Select the Department" InitialValue="--Select--"  ValidationGroup="submit" ForeColor="Red" Display="Dynamic"  SetFocusOnError="true" ControlToValidate="DepartmentDDList"></asp:RequiredFieldValidator>
        ...
        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="Enter the Manager Id"  ValidationGroup="submit" ForeColor="Red"  ControlToValidate="ToTextBox" SetFocusOnError="true"></asp:RequiredFieldValidator>
             ...
             <div class="row" >
                 ...
                 <asp:Button ID="AddDetailsSubmit" CssClass="form-control btns btb-primary" Width="100%" style="color:white;font-size: initial;margin-right: 5px;" BorderColor ="DodgerBlue"  runat="server" Text="Add Supervisor" OnClick="AddDetailsSubmit_Click"  ValidationGroup="submit" />
      ...
      <div class="row">
           <div class="col-sm-12">
                 ...
                 <asp:Button ID="UpdateButton" CssClass="form-control btns btb-primary" ValidationGroup="submit" Width="100%" BorderColor ="DodgerBlue" style="color:white;font-size: initial;margin-right: 5px;"  runat="server" Text="Alter" OnClick="UpdateButton_Click"  />  
           </div>
           ...
           <div class="col-sm-12">
                 ...
                 <asp:Button ID="Deletebtn" CssClass="form-control btns btb-primary" Width="100%" ValidationGroup="submit" BorderColor ="DodgerBlue" style="color:white;font-size: initial;margin-right: 5px;"  runat="server" Text="Delete" OnClick="DELETE_Click"   />  
           </div>
