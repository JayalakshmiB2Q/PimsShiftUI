            ...
            <div class="modal-dialog modal-lg">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <input type="button" id="impl_btn" class="form-control apopbtn btn-primary"  " value="Send" onclick="sendEmail();"/>    <%-- OnClick="Submit_Click" OnClientClick="return submitBtn();"  style="display:none;" --%>
   ...
   <script>
    ...
    <script>
        function sendEmail() {
           ...
           {
                document.getElementById("impl_btn").disabled = true;
                $("#preloader").hide();
