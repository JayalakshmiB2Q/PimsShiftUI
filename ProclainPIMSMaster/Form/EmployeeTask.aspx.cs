    ...
    public partial class EmployeeTask : System.Web.UI.Page
    {
        ...
        public void load()
        {
            ...
            else
            {
                ...
                Ds = em.ImplTeamEvalRepViewReassign(em);
                int cass = Ds.Tables[0].Rows.Count;
                countass.InnerHtml = cass.ToString();


                MailRepeaterreassign.DataSource = Ds.Tables[0];
                //MailRepeater.SelectMethod = "IdeaId";
                MailRepeaterreassign.DataBind();
        ...
        public void DepIdAuto()
        {
            try
            {
                em.IdeaID = IMPIdeaIdTextBox.Text.ToString();
                DataSet DS = new DataSet();
                DS = em.depIDAuto(em);
        ...
        public void TeamEvaluvationInsert()
        {
            ...
            try
            {
                ...
                //ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "alertMessage", "swal('Suggestion','Mail sended','Success')", true);
                ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "alertMessage", "alert('Mail sended')", true);
                z = 1;
        ...
        public static CEmpEmailContents MailContent(string idea)
        {
            ...
            try
            {
               ...
               em.IdeaID= idea.ToString();
                ...
                {
                    MM.IdeaId = idea.ToString();
                    DS = MM.Manager_dtails_Mail_view(MM);
        ...
        [WebMethod()]
        public static CESEmpEmailContents MChecking(string idea) 
        { 
            ...
            try
            {
                ...
                try
                {
                    ...
                    if (idea != "" && idea != "System.Data.DataRowView")
                    {
