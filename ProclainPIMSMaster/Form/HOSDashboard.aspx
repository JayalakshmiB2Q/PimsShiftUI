        ...
        <asp:DropDownList ID="ddlBenifialTeam" CssClass="DepJQuery listbox  form-control" runat="server"></asp:DropDownList> </div>
                                      ...
                                      <ul id="ManagerContainer" >
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-10"> 
                                                <textarea required="required" id="txtMailBody"class="form-control  inp SendToTextBoxclass" name="txtMailBody"  cols="20" rows="2"></textarea>

                                                </div>
                                            </div>
                                         <label id="task3" visible="false"  style="color:red; display:none";>Enter the Fields</label>
                                       <%-- <div class="row">
    ...
    <%-- IdeaID Sender to BackEnd  --%>
     <script>
         function sendEmail() {
             ...
             var txtarea = $("[id*=txtMailBody]").val(); 
             var gradearea = $("[id*=fname2]").val();
             if (txtarea =="") {
                 document.getElementById("task3").style.display = "block";
                 $("[id*=txtMailBody]").focus();
             }
             else if (gradearea=="")
             {
                 document.getElementById("task3").style.display = "block";
                 $("[name*=gradeText]").focus();
             }
             else {
                 document.getElementById("task3").style.display = "none";
