<%@ Page Title="" Language="C#" MasterPageFile="~/ManagerMaster.Master" AutoEventWireup="true" CodeBehind="ManDashboardReport.aspx.cs" Inherits="ProclainPIMSMaster.Form.ManDashboardReport" %>
...
<script type="text/javascript">                                      				                                        				    
    function bindgraph(New, To_HOD, Resend_HOD, countFromImpl) {
        console.log('method called ', New, To_HOD, Resend_HOD, countFromImpl);
        var New = [parseInt(New)];     
        var To_HOD = [parseInt(To_HOD)];       
        var Resend_HOD = [parseInt(Resend_HOD)];
        var countFromImpl = [parseInt(countFromImpl)];
                                            ...
                                            var Config = {
                                                "graphset": [{
                                                    "globals": {
                                                        "font-family": "Lato",
                                                        "title": {
                                                            "text": " Manager Suggestions Count status",
                                                ...
                                                "scaleX": {
                                                   ...
                                                   "New", "To_HOD", "Resend_HOD", "countFromImpl",
                                            ...
                                            zingchart.bind(null, 'node_click', function (e) {
                                                ...
                                                swal({
                                                    ...
                                                    if (isConfirm) {
                                                        ...
                                                        else if (e.scaletext === "To_HOD") {
                                                            console.log("enterbar");
                                                            Ass_OwnExcel();
                                                        }
                                                        
                                                        else if (e.scaletext === "Resend_HOD") {
                                                            console.log("enterbar");
                                                            From_ImpExcel();
                                                        }
