<%@ Page Title="" Language="C#" MasterPageFile="~/DBM.Master" AutoEventWireup="true" CodeBehind="HOSAdd.aspx.cs" Inherits="ProclainPIMSMaster.Form.HOSAdd" %>
...
<%--<div class="col-12 peer pX-40  h-100 bgc-white scrollable pos-r" style="min-width:320px; padding-top: 28px">--%>
    ...
    <div class="row">
    <div class="col-lg-8 form-control" style="margin-left: 198px;">
         <div class="leftside no-gutters">
             <center><h4 class="text-black"><b>HOD Create Form</b></h4> </center>
            ...
            <div class="row align-items-center">
                 <div class="col-sm-4">
                    ...
                    <asp:TextBox ID="EmployeeIdTextBox" CssClass="form-control bor  Emplidclass" style="text-transform:uppercase;" placeholder="Employee Id" runat="server"  onkeydown="return tableInputKeyPress(event);"></asp:TextBox>
                     <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Enter the ID" ValidationGroup="submit" ForeColor="Red" ControlToValidate="EmployeeIdTextBox" SetFocusOnError="true"></asp:RequiredFieldValidator>
                     </div>
                     </div>
                     <br />
                     <div class="row">
             ...
             <br />
                ...
                <div class="col-sm-4">
                    <label>Department</label>
                         ...
                         <div class="col-sm-8">
                  <asp:DropDownList ID="DepartmentTxtBox" CssClass="form-control bor" Width="100%" Enable="true" runat="server" AutoPostBack="false" AppendDataBoundItems="True">
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Select the Department" InitialValue="--Select--"  ValidationGroup="submit" ForeColor="Red" Display="Dynamic"  SetFocusOnError="true" ControlToValidate="DepartmentTxtBox"></asp:RequiredFieldValidator>
    ...
    <div class="form-group">
       ...
       <%-- <div class="col-sm-2"style="margin-left: 400px;margin-bottom: -50px">
                <div class="peer">
                 <asp:Button ID="Submit" CssClass="form-control rep" style="color:white"  runat="server" Text="Submit" OnClick="Submit_Click" />
                 
                 </div>
                 <div class="col-sm-2"style="margin-left: 400px;margin-bottom: -50px">
                <div class="peer">
                 <asp:Button ID="Button2" CssClass="form-control rep" style="color:white"  runat="server" Text="Update" onclick="Update_Click" />
    ...
    <div class="col-sm-2">
        ...
        <div class="col-sm-2"style="margin-left: 521px;margin-bottom: -36px">
                <div class="peer">
                 <asp:Button ID="Delete" CssClass="form-control rep" Width="100%" BorderColor ="DodgerBlue" style="color:white"  runat="server" Text="Delete" OnClick="Delete_Click" />
    ...
    <div class="col-sm-2">
             <asp:Label ID="Label2" runat="server" Text="Label" Visible="false"></asp:Label>              
              ...
              <div class="col-sm-2"style="margin-left: 653px;">
                <div class="peer">
                 <asp:Button ID="Button1" CssClass="form-control rep" Width="100%" BorderColor ="DodgerBlue" style="color:white"  runat="server" Text="Back" OnClick="back_Click" />
    ...
    <div class="col-sm-2">
     ...
     <div class="btn-group" style="float: right; margin-top: -28px;">
     
              
                 <asp:Button ID="Submit" CssClass="form-control rep" style="color:white"  runat="server" Text="Submit" ValidationGroup="submit" OnClick="Submit_Click" />
  
            
              
                 <asp:Button ID="Button2" CssClass="form-control rep" style="color:white"  runat="server" Text="Update" ValidationGroup="submit" onclick="Update_Click" />
              
                 <asp:Button ID="Delete" CssClass="form-control rep" Width="100%" BorderColor ="DodgerBlue" style="color:white" ValidationGroup="submit"  runat="server" Text="Delete" OnClick="Delete_Click" />
