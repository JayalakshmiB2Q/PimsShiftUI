        ...
        public void Upinsert()
        {
            try
            {
                ...
                if (index != "" && index != "System.Data.DataRowView")
                {
                    ...
                    //string myscript = "alert ('Thanks For Response');";
                    //Page.ClientScript.RegisterClientScriptBlock(this.GetType(), "MyScript", myscript, true);
                   // ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "alertMessage", "swal('THANKS FOR YOUR RESPONCE','success')", true);
                }
                else
                {
                    //string myscript = "alert ('Forget To Select the IDea ID');";
                    //Page.ClientScript.RegisterClientScriptBlock(this.GetType(), "MyScript", myscript, true);
                    ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "alertMessage", "swal('OOPS','Forget To Select the IDea ID','warning')", true);
