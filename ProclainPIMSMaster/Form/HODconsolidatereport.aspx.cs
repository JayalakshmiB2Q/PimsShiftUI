...
{
    public partial class HODconsolidatereport : System.Web.UI.Page
    {
        ...
        protected void SuggestionGridView_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            {
                if (e.Row.Cells[8].Text == "Suggestion Received")
                {
                    e.Row.Cells[8].Text = "received";
                }
                else if (e.Row.Cells[8].Text == "REJECT BY SUPERVISOR")
                {
