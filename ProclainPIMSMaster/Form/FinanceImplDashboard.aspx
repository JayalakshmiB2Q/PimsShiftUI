                                     ...
                                     <HeaderTemplate >
                                                    ...
                                                    <ItemTemplate>
                                                        <tr>
                                                            ...
                                                            <td class="neons" colspan="1"  data-tooltip="tooltip" data-placement="right" title="C L I C K "  data-toggle="modal" data-target="#myModalImpIdeaForm" >
                                     ...
                                     <HeaderTemplate >
                                                    ...
                                                    <ItemTemplate>
                                                        <tr>
                                                            ...
                                                            <td class="neons" colspan="1"  data-tooltip="tooltip" data-placement="right" title="C L I C K "  data-toggle="modal" data-target="#fullHeightModalRight" >
                                                                <asp:Label ID="lblCountry"  runat="server" CssClass="neons" Text='<%# Eval("IDeaID") %>'   />
                                                            </td>
...
<!-- Full Height Modal Right -->
  ...
  <div class="modal-dialog modal-full-height modal-right" role="document">--%>
    ...
    --%>
       <div class="container">
        <div class="modal fade" id="myModalImpIdeaForm" role="dialog" style="background-color: #0b0340;">
                        ...
                        <div class="container">
                            ...
                            <div class="email-compose-body">
                              ...
                              <div class="col-md-6 form-group">
                                ...
                                <div class="col-md-6 form-group">                                    <label>Cash Mode:</label>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                <div class="form-group">
                                    <asp:Button ID="GetREportIndividual" runat="server" CssClass="form-control apopbtn btn-info" Text="Get Report Detail" OnClick="GetREportIndividual_Click" />  
       ...
       <script>
                ...
                $('#newtable').on("click", "tr td[colspan]", function (e) {
                   // alert('ssssssssssssssssss');
                    ...
                    //var a = $("[id*=lblImageNameTextBox]").val();
                  //  alert(IdeaID);
                    neons();
