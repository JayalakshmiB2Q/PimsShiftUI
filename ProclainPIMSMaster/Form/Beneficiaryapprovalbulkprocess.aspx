                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-10"> 
                                               <%-- <textarea id="txtMailBody"class="form-control  inp SendToTextBoxclass" name="txtMailBody" cols="20" rows="2"></textarea>--%>
                                                <asp:TextBox ID="txtMailBody" class="form-control  inp SendToTextBoxclass" runat="server" name="txtMailBody" cols="20" rows="2" TextMode="MultiLine"></asp:TextBox>
                                                </div>
                                            </div>
                                            </div>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtMailBody"  ErrorMessage="Enter the Fields" ValidationGroup="submit" ForeColor="Red" Font-Bold="True" SetFocusOnError="True"></asp:RequiredFieldValidator>
                                            </div>
                        ...
                        <div class="modal-footer">
                                 <asp:Button ID="DBMButton" runat="server"   Text="Send" CssClass="form-control apopbtn btn-primary"  ValidationGroup="submit"  OnClick="send_Click" />
