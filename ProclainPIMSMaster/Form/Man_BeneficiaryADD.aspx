<%@ Page Title="" Language="C#" MasterPageFile="~/ManagerMaster.Master" AutoEventWireup="true" CodeBehind="Man_BeneficiaryADD.aspx.cs" Inherits="ProclainPIMSMaster.Form.Man_BeneficiaryADD" %>
...
<%--<div class="col-12 peer pX-40  h-100 bgc-white scrollable pos-r" style="min-width:320px; padding-top: 28px">--%>
    ...
    <div class="col-lg-4 form-control" >
         <div class="leftside no-gutters">
             <center><h4 class="fw-300 c-grey-902 mB-30">Beneficiary Records</h4> </center>
