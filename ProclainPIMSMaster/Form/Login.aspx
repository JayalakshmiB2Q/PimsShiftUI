...
<head runat="server">
    ...
    <title>Sign In</title>
        <style>
            ...
            .bckimg{
            background-image:url(../UI/assets/static/images/Poclain%20Image.JPG);
...
<body class="app" onload="myFunction()">
    <form id="form1" runat="server" method="post">
        ...
        <div id="loader">
            ...
            <p style="text-align:center;">WELCOME TO PIMS  ShiftUP.....</p>
        </div>
        ...
        <div class="peers ai-s fxw-nw h-100vh">
            <div class="bckimg" style="width:100%;height:100%; ">
                ...
                <div class="card" style="opacity:0.8; width:40%;height:40%;margin-left:30%;margin-top:12%;align-content:center;border-radius:10px;background-color:lightgray">
                   ...
                   <div style="padding-left:15px;">
                       <h3 class="fw-300 c-grey-900 mB-40"><b>Login</b></h3>
                        <div class="row" style="width:100%">
                            ...
                            <div class="col-md-12"><asp:TextBox ID="EmployeeIDTextBox" CssClass="form-control input-append" style="border-radius:20px;margin-right:20%;" onkeyup="this.value=this.value.toUpperCase()" placeholder="Type Your Employee ID Here.." runat="server" AutoPostBack="false" ></asp:TextBox></div>
                        </div>
