    ...
    public partial class ManagerList : System.Web.UI.Page
    {
            ...
            try
            {
                ...
                else
                {
                    if (!IsPostBack)
                    {
                        ...
                        ProclainPIMSMaster.DBM admaster = (ProclainPIMSMaster.DBM)this.Master;
        ...
        public void DepartmentNameDDList()
        {
            try
            {
                ...
                DepartmentTextBox.DataValueField = "DepId";
        ...
        public void clear()
        {
            ...
            DepartmentTextBox.SelectedIndex = 0;
            DropDownList_HOd.SelectedIndex = 0;
            txtHodId.Text = "";
                ...
                if (EmployeeIdTextBox.Text != "" && EmployeeIdTextBox.Text != "System.Data.DataRowView")
                {
                    try
                    {
                        ...
                        else
                        {
                            ...
                            M.hodid = txtHodId.Text.ToString().TrimStart().TrimEnd();
                            M.Remark1 = "i";
        ...
        [WebMethod]
        public static List<ListItem> MChecking(string emp)
        {
            Manager M = new Manager();
