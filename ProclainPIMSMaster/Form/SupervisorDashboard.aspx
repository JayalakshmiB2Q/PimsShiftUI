<%@ Page Title="" Language="C#" MasterPageFile="~/Superviser.Master" AutoEventWireup="true" CodeBehind="SupervisorDashboard.aspx.cs" Inherits="ProclainPIMSMaster.Form.SupervisorDashboard" EnableEventValidation="false" %>
...
<%--                                         <li class="nav-item" id="hidereject">
                                            <a class="nav-link" data-toggle="tab" href="#FromIMPL">FROM IMPLEMENTER &nbsp;<span id="countFromImpl" class="badge badge-pill badge-danger" runat="server">0</span></a>
                                        </li>
                                        ...
                                        <li class="nav-item" id="hideassign">
                                            <a class="nav-link" data-toggle="tab" href="#Assigned">TO IMPLEMENTER&nbsp;<span id="countass" class="badge badge-pill badge-primary" runat="server">0</span></a>
                                        </li>
                                      ...
                                      <%--  <li class="nav-item" id="hidecomplete">
                                            <a class="nav-link" data-toggle="tab" href="#SEND">TO Implementor &nbsp;<span id="countcom" class="badge badge-pill badge-primary" runat="server">0</span></a>
                                        </li>
                                        --%>
       ...
       <%-- </div>--%>
        ...
        <div class=" col-lg-12 reps"  id="show"  tabindex="0" style="display:none">
            <div class="rightside no-gutters" style="margin-right: 50px;" id="UPDT1">
                                            ...
                                            <ContentTemplate>
                                                ...
                                                <div class="pear">                                                  
                                                    <div align="center">
                                                        ...
                                                        <mark class="form-control textalign " id="SubjectTag" style="text-align: left; text-transform: uppercase; font-size: 30px; border: 0px solid; padding-bottom: 0px; padding-left: 0px; padding-right: 5px; padding-top: 2px; text-align: center;border: ridge;
    color: black;"></mark>
                                                        
                                                    </div>
                                                   
                                                    <table id="viewtbl" align="center" class="table table-bordered" style="border-style: ridge; width: 1000%;">
                                                        <!--visibility:hidden;-->
                                                        <tr>
                                                            <td><mark id="IdIdTag" class="fnt"></mark></td>
                                                            <td><mark id="IdeaIdTag" style="padding-left: 10px"></mark>
                                                                <asp:TextBox ID="CEideaidTextBox" runat="server" CssClass="ideaidclass" hidden=""></asp:TextBox>
                                                            </td>
                                                        <tr>
                                                            <td><mark id="fromTag" class="fnt"></mark></td>
                                                            <td><mark id="EmployeeNameTag"></mark></td>
                                                        </tr>
                                                        <tr>
                                                            <td><mark id="EIDTag" class="fnt"></mark></td>
                                                            <td><mark id="EmployeeIDTag"></mark></td>
                                                        </tr>
                                                        <tr hidden="">
                                                            <td><mark id="DBMlblTag" class="fnt"></mark></td>
                                                            <td><mark id="DBMTag"></mark></td>
                                                        </tr>
                                                        <tr>
                                                            <td><mark class="fnt">Date :</mark> </td>
                                                            <td>
                                                                <h6 id="TimeTag"></h6>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td><mark id="BefTag" class="fnt"></mark></td>
                                                            <td><mark id="BeforeTag"></mark></td>
                                                        </tr>
                                                        <tr>
                                                            <td><mark id="AftTag" class="fnt"></mark></td>
                                                            <td><mark id="AfterTag"></mark></td>
                                                        </tr>
                                                        <tr>
                                                            <td><mark id="CatTag" class="fnt"></mark></td>
                                                            <td><mark id="CategoryTag"></mark></td>
                                                        </tr>
                                                        <tr>
                                                            <td><mark id="DepTag" class="fnt"></mark></td>
                                                            <td><mark id="DepartmentTag"></mark></td>
                                                        </tr>
                                                        <tr>
                                                            <td><mark id="DesTag" class="fnt"></mark></td>
                                                            <td><mark id="DesignationTag"></mark></td>
                                                        </tr>
                                                        <tr>
                                                            <td><mark id="BenTag" class="fnt"></mark></td>
                                                            <td><mark id="BenefitsTag"></mark></td>
                                                        </tr>
                                                         </table>
                                                        <div class="row">
                                                            <div class="col-md-4">
                                                                ...
                                                                <div class="row-md-6">
                                                                    ...
                                                                    <div id="fileAt1" style="display: none">
                                                                        <caption>
                                                                            <a id="attachement1" class="btn btn-info" href="#" target="_blank">Download Attachment 1</a>
                                                                        </caption>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-4">
                                                                ...
                                                                <div class="row-md-6">
                                                                    ...
                                                                    <div id="fileAt2" style="display: none">
                                                                        <caption>
                                                                            <a id="attachement2" class="btn btn-info" href="#" target="_blank">Download Attachment 2</a>
                                                                        </caption>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-4">
                                                                ...
                                                                <div class="row-md-6">
                                                                    ...
                                                                    <div id="fileAt3" style="display: none">
                                                                        <caption>
                                                                            <a id="attachement3" class="btn btn-info" href="#" target="_blank">Download Attachment 3 </a>
                                                                        </caption>
                                                                    </div>
                                                                </div>
                                                            </div>
...
span.onclick = function() { 
  modal.style.display = "none";
                 ...
                 <div id="hideresendpopup" style="text-align: right; color: #f8f8f8;    font-size: xx-large; padding-inline: 30px; letter-spacing: 10px!important" >
                  ...
                  <div  <%--class="sidebar-menu scrollable pos-r"--%> style="text-align: right; color: #f8f8f8;    font-size: xx-large; padding-inline: 30px; letter-spacing: 10px!important" id="hideownotherpopup">
                    <%--  <div class="nav-item mT-30 active" style="color: #f8f8f8 !important"--%>
                            <a href="javascript:void(0)" <%--class="nav-link c-grey-800  cH-blue-500 active  !important--%>" data-toggle="modal" data-target="#myModalOwnTeamMembers">
                                ...
                                <span <%--class="icon-holder iconmenu dot"--%> data-toggle="tooltip" data-placement="top" title="Own Team ">
                                    <%--<a type="button" class="fa fa-check-square-o" style="color: green"></a>--%>
                                    <button type="button" class="btn btn-success">Own Team</button>
                                </span>
                           ...
                           <a href="javascript:void(0)" <%--class="nav-link c-grey-800 cH-blue-500 active"--%>   data-toggle="modal" data-target="#myModalComiteeEvaluation">
                                ...
                                <span  class="icon-holder iconmenu dot" data-toggle="tooltip" data-placement="top" title="Other Department">
                                   <%-- <i class="fa fa-external-link" style="color: coral"></i>--%>
                                     <button type="button" class="btn btn-primary">Other Department</button>
                              </span>
    ...
    <div class="container">
       ...
       <div class="modal-dialog modal-xl">
                ...
                <div class="modal-content">
                            ...
                            <form class="email-compose-body">                               
                              <div class="row"> 
                               <div class=" form-group">
                                ...
                                <div class="col-cmd-5 form-group">
                                        <label>Date</label>                                        
                                ...
                                <div  id="feasible">
                                     <div class="row">
                                    <div class="col-sm-4 form-group">                                        
                                            <label id="team_mem">Team Members: </label>
                                            <asp:DropDownList ID="TeamNamePopUPDDList" CssClass="js-example form-control DDJQuery DDJClass" runat="server"  AutoPostBack="false" AppendDataBoundItems="True">
                                  ...
                                  <div class="col-sm-12 form-group">
                                        <label>Subject</label>
                                        <asp:TextBox ID="subjecttext" CssClass="form-control inp subjecttext " Style="pointer-events: none;"  placeholder="Mail Subject" runat="server"></asp:TextBox>
                                         <label id="sub" class="hiddendiv" style="color:red">Enter The Subject Content</label>
                                    </div>
                                 <div class=" col-sm-12 form-group">
                                        <label>Remarks</label>
                                        <asp:TextBox ID="ComposeTextBox" CssClass="form-control inp" runat="server" placeholder="Remark" TextMode="MultiLine" Rows="10"  style=" height: 36px;"></asp:TextBox>
                                        <label id="sub1" class="hiddendiv" style="color:red">Enter The Fields</label> 
                    ...
                    <div class="modal-footer">
                        <asp:Button ID="OwnTeamPopButton" runat="server" CssClass="form-control apopbtn btn-primary" Text="Send" OnClick="OwnTeamPopButton_Click" Style="display: none;" OnClientClick="DisableButton()" />
                        <input type="button" id="ownbtn" class="form-control apopbtn" style="width: 100%;"  value="Send" onclick="sendEmail()"  />
   ...
   <script>
        function sendEmail() {
           ...
           // document.getElementById('sub2').className = 'hiddendiv';
            ...
            var toid = $("[id*=EmpIDTextBox]").val(); 
      
           
           
            if (sub1 == "" || sub1 == null) {
                $("[id*=ComposeTextBox]").focus(); 
                 document.getElementById('sub1').className = 'visiblediv';                
                document.getElementById("ownbtn").disabled=false;
            } 
             else if(toid == ""|| toid == null)
            {
                 $("[id*=TeamNamePopUPDDList]").focus();
                document.getElementById('sub1').className = 'visiblediv'; 
            }
           
             else {
                 document.getElementById("ownbtn").disabled=true; 
                $("#preloader").hide();
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="container">
                            ...
                            <div class="email-compose-body">
                              ...
                              <%--  <div class="send-header">--%>
                                    <div class="col-sm-6 form-group ">
                                        <label>Idea Id</label>
                                        <asp:TextBox ID="TextBox1" CssClass="form-control inp IdeaIDClass" Style="pointer-events: none;"  placeholder="Idea ID" onkeydown="return MoveNext('HodNameTextBox',event.keyCode);" runat="server"></asp:TextBox>
                               ...
                               <%-- </div>--%>
                                ...
                                <div class="col-sm-6 form-group">
                                    <div class="peers">
                                        ...
                                        <asp:TextBox ID="EmpIDIMPTextBox" CssClass="form-control inp IMPEmpIDTextBoxClass" placeholder="To: " Style="pointer-events: none;"  runat="server" hidden></asp:TextBox>
                                ...
                                <div class="col-sm-6 form-group">
                                    <label>Mail ID: </label>
                                    <asp:TextBox ID="MailIdIMPTextBox" CssClass="form-control inp IMPmailidtextClass" Style="pointer-events: none;"  placeholder="Mail ID" runat="server"></asp:TextBox>
                         ...
                         <label id="othercom" class="hiddendiv" style="color:red">Enter The Fields</label>
                    </div>
                    ...
                    <div class="modal-footer">
                        ...
                        <input type="button" id="ManagerBtn" class="form-control apopbtn" style="width: 100%;"  value="Send" onclick="sendEmailtoOtherteam()" />
                        <%-- OnClick="Submit_Click" OnClientClick="return submitBtn();"  style="display:none;" --%>
                    ...
                    <div class="modal-body">
                        <div class="container">
                            ...
                            <div class="email-compose-body">
                                ...
                                <div class="form-group">
                                    <label>Remarks</label>
                                    <asp:TextBox ID="DBMRemark" CssClass="form-control inp" runat="server" placeholder="Remarks" TextMode="MultiLine" Rows="10"></asp:TextBox>
                            ...
                            <div class="email-compose-body">                               
                                <div class="send-header">
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox ID="ReassignIdeaId" CssClass="form-control inp IdeaIDClass" placeholder="Idea ID"  runat="server"></asp:TextBox>
                                ...
                                <div class="form-group">
                                 ...
                                 <div class="form-group">
                                        <label>Remarks</label>
                                        <asp:TextBox ID="ReassignCmts" CssClass="form-control inp" runat="server" placeholder="Remark" TextMode="MultiLine" Rows="10"></asp:TextBox>
                                        <%--<textarea name="composetextarea" runat="server" class="form-control" placeholder="Remark BY Team" rows="10"></textarea>--%>
                                    </div>
                                <div class="form-group">
                                     <div class="row">
                        ...
                        <div class="container">
                            ...
                            <div class="email-compose-body">
                                ...
                                <%--<div class="form-group">
                                 ...
                                 <div class="form-group">
                                        <label>Remarks</label>
                                        <asp:TextBox ID="TextBox4" CssClass="form-control inp" runat="server" placeholder="Remarks" TextMode="MultiLine" Rows="10"></asp:TextBox>
                                        <%--<textarea name="composetextarea" runat="server" class="form-control" placeholder="Remark BY Team" rows="10"></textarea>--%>
                                    </div>
                              <%--  <div class="form-group">
                                     <div class="row">
    ...
    <script>
        function sendEmailtoOtherteam() {
            ...
            if (otherdep == "" || otherdep == null) {
                ...
                var someSession = '<%= Session["UserName"].ToString() %>';
                var empid = '<%= Session["UserId"].ToString() %>';
                var Des = '<%= Session["Designation"].ToString() %>';
                var Designation = Des.trim();
 ...
 <%--   <script>
        ...
        $('.neons').click(function () {
          ...
          $(document).scrollTop($(document).height());
            ...
            if (key == 0) //Enter
            {
                ...
                $.ajax({
                    url: 'SupervisorDashboard.aspx/MailContent',
                    method: 'post',
                    ...
                    success: function (data) {
                        ...
                        //document.getElementById("subjecttext").innerHTML = data.d.subject;
    ...
    <script>
        function ManagerFilter(IdeaID) {
            ...
            $.ajax({
                url: 'SupervisorDashboard.aspx/ManagerFilter',
                method: 'post',
                contentType: "application/json; charset=utf-8",
                async: true,
                dataFilter: function (data) { return data; },
                    ...
                    if (txts != "") {
                      ...
                      //  $(".IMPToTextBoxClass").val(txts);
                        console.log("TT:" + textboxs2 + 'textbox:' + txts);
                            ...
                            console.log(ks);
                            $.ajax({
                                url: 'SupervisorDashboard.aspx/MCheckings',
                                method: 'post',
                                contentType: "application/json; charset=utf-8",
                                async: true,
                                dataFilter: function (data) { return data; },
                                ...
                                success: function (data) {
                                 ...
                                 //   $(".IMPToTextBoxClass").val(data.d.HEmployeeID);
                                  //  $(".IMPmailidtextClass").val(data.d.Email);
                                   ...
                                   var fxs = "";
                                    ...
                                    $(".IMPToTextBoxClass").val(feids);
                                    $(".IMPmailidtextClass").val(fs);
                                 //   var EIDs = $(".EmpIDTextBoxClass").val().toString();
                                 //  var zs = $(".IMPmailidtextClass").val().toString();
                                 //   if (zs == "") {
                                 //       fxs = zs + " " + fs;
                                        
                                 //       fzs = EIDs + "" + feids;
                                 //       console.log("fzs value="+fzs);
                                 //   }
                                 //   else {
                                 //       console.log("Textbox" + txts);
                                 //       fxs = (zs + ',' + " " + fs);
                                 ...
                                 //   }
                                 //var tempmail=  $(".IMPmailidtextClass").val(fxs);
                                 //   console.log("empid="+fzs);
                                 //   console.log("empid="+EIDs);
                                 //   console.log( $(".EmpIDTextBoxClass").val(fzs));
                                 //  var temp_empid=  $(".IMPToTextBoxClass").val(fzs);
                                //var mmmm =  document.getElementById('#TOIMPTextBox').value ;
                ...
                if (txt != "--Select--") {
                    if (txt != "") {
                        ...
                        console.log("TT:" + textbox2 + 'textbox:' + txt);
                         ...
                         var feid = "";
                            $.ajax({
                                url: 'SupervisorDashboard.aspx/Checking',
                                method: 'post',
                                contentType: "application/json; charset=utf-8",
                                async: true,
                                dataFilter: function (data) { return data; },
            ...
            if (key == 0) //Enter
            {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        document.getElementById("upl3TagA").innerHTML = "After Implement : ";
                        document.getElementById("SubjectTagA").innerHTML = data.d.subject;
 ...
 $(document).ready(function () {
    ...
    <%--<%--     <script type="text/javascript">
             function DisableButton(id) {
                 alert(id);
                 if(id=="1"){
                   window.onload-document.getElementById("OTPOPBtn").disabled = true;
