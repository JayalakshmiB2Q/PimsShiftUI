            ...
            try
            {
                ...
                if (EmployeeIDTextBox.Text != "" && PasswordTextBox.Text != "")
                {
                    ...
                    if (EmployeeIDTextBox.Text == "admin" && PasswordTextBox.Text == "admin")
                    {
                        ...
                        Response.Redirect("Default.aspx?value=" + EmployeeIDTextBox.Text.ToString());
                    }
                    else
                    {
                        SignInInsert();
                    ...
                    if (P == LP)
                    {
                        ...
                        else
                        {
                            if (Rmk != "D")
                            {
                                ...
                                if (chk == "staff" && mailid == "jeyapandi.palani@poclain.com" || chk == "staff" && mailid == "sivabalan.gunasekara@poclain.com" || mailid == " vaithiyanathan.solai @poclain.com")
                                {
                                    RL.LogInsert(RL);
