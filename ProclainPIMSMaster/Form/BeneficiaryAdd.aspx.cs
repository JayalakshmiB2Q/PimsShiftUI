...
{
    public class MtestDataPasserBen
    {
    ...
    public partial class BeneficiaryAdd : System.Web.UI.Page
    {
        ...
        public void insert()
        {
            try
            {
                ...
                if (EmployeeIdTextBox.Text != "" && EmployeeIdTextBox.Text != "System.Data.DataRowView")
                {
                    ...
                    M.Remark1 = "i";
                    M.BENDetailInsert(M);
                    string myscript = "alert ('Beneficiary Detail Added');";
        ...
        protected void Delete_Click(object sender, EventArgs e)
        {
             try
            {
                ...
                if (EmployeeIdTextBox.Text != "" && EmployeeIdTextBox.Text != "System.Data.DataRowView")
                {
                    ...
                    M.BENDetailDelete(M);
                    string myscript = "alert ('Beneficiary Detail Deleted');";
                    Page.ClientScript.RegisterClientScriptBlock(this.GetType(), "MyScript", myscript, true);
                    SuggestionTableView();
                    clear();
