    ...
    <div class="container">
       ...
       <div class="modal-dialog modal-xl">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <input type="button" id="ot_lbl" class="form-control apopbtn" style="width: 100%;" value="Send" onclick="sendEmail()" />
        ...
        function sendEmail() {
           ...
           // document.getElementById('sub2').className = 'hiddendiv';
            ...
            if (sub == "" || sub == null) {
                ...
                $("#preloader").hide();
                document.getElementById("ot_lbl").disabled=true;
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                            ...
                            <div class="email-compose-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <asp:RadioButtonList ID="RadioButtonReassign" runat="server" Style="margin-left: 20px; margin-top: 20px;" RepeatDirection="Vertical" RepeatColumns="2" >
                                     ...
                                     <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="please select any one" ControlToValidate="RadioButtonReassign"   ValidationGroup="submit" Font-Bold="True" SetFocusOnError="true"  ForeColor="Red"></asp:RequiredFieldValidator>
                                </div>
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Enter the Remarks" ControlToValidate="ReassignCmts"   ValidationGroup="submit" Font-Bold="True" SetFocusOnError="true"  ForeColor="Red"></asp:RequiredFieldValidator>
                         
                    </div>

                    <div class="modal-footer">
                        <asp:Button ID="ReassignOT_OR_FWDHOD" runat="server" CssClass="form-control apopbtn btn-primary" Text="Send" OnClick="ReassignOT_OR_FWDHOD_Click"  ValidationGroup="submit" />
