	...
	<div class="row">
		...
		<div class="col-md-3">
			<div class="dbox dbox--color-2">
				...
				<div class="dbox__body">
					<span  id="countRS_HOD" runat="server" class="dbox__count">0</span>
					<span class="dbox__title">From HOD</span>
				</div>											
			</div>
		</div>
        ...
        <div class="col-md-3">
			<div class="dbox dbox--color-2">
				...
				<div class="dbox__body">
				 <span id="countcom" runat="server" class="dbox__count">0</span>          
					<span class="dbox__title">To HOD </span>
				</div>
         ...
         <div class="col-md-3">
			<div class="dbox dbox--color-2">
				...
				<div class="dbox__body">
				 <span id="countFromImpl" runat="server" class="dbox__count">0</span>          
					<span class="dbox__title">Resend Implementer </span>
				</div>
