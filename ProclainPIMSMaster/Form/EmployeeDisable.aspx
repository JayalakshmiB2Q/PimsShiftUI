<%@ Page Title="" Language="C#" MasterPageFile="~/DBM.Master" AutoEventWireup="true" CodeBehind="EmployeeDisable.aspx.cs" Inherits="ProclainPIMSMaster.Form.EmployeeDisable" %>
    ...
    <div class="col-lg-3 form-control" style="height: 371px;" >
        ...
        <br />
             ...
             <div class="row" >
                 ...
                 <asp:Button ID="AddDetailsSubmit" CssClass="form-control  btn" Width="100%" style="color:white;font-size: initial;margin-right: 5px;" BorderColor ="DodgerBlue"  runat="server" Text="Disable" OnClick="AddDetailsSubmit_Click"  />
              
                      </div>
                 <%--<div class="col-sm-6">--%>
                          <asp:Button ID="SearchsButton" CssClass="form-control btn" Width="100%" BorderColor ="DodgerBlue"  runat="server" Text="Search" Visible="false" OnClick="SearchButton_Click" />
                 ...
                 <asp:Button ID="Enable" CssClass="form-control btn btb-primary" Width="100%" BorderColor ="DodgerBlue" style="color:white;font-size: initial;margin-right: 5px;"  runat="server" Text="Enable" OnClick="Enable_Click"  />
     ...
     <script>
        function CMtableInputKeyPress(e) {
            ...
            {   
                ...
                $.ajax({
                    url: 'EmployeeDisable.aspx/CMChecking',
                    method: 'post',
                    contentType: "application/json; charset=utf-8",
                    async: true,
