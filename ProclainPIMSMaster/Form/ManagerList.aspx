<%@ Page Title="" Language="C#" MasterPageFile="~/DBM.Master" AutoEventWireup="true" CodeBehind="ManagerList.aspx.cs" Inherits="ProclainPIMSMaster.Form.ManagerList"  EnableEventValidation="false"  %>
...
<%--<div class="col-12 peer pX-40  h-100 bgc-white scrollable pos-r" style="min-width:320px; padding-top: 28px">--%>
             ...
             <br />
                ...
                <div class="col-sm-4">
                    ...
                    <%--<asp:TextBox ID="DepartmentTextBox" CssClass="form-control bor" Width="100%" Enable="true" placeholder="Department Name" runat="server"></asp:TextBox>--%>
                        <asp:DropDownList ID="DepartmentTextBox" CssClass="form-control bor" Width="100%" Enable="true" runat="server" AutoPostBack="false" AppendDataBoundItems="True">
                        <asp:ListItem>--Select--</asp:ListItem>
                        </asp:DropDownList>  
                                      
                         <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Select the Department" InitialValue="--Select--"  ValidationGroup="submit" ForeColor="Red" Display="Dynamic"  SetFocusOnError="true" ControlToValidate="DepartmentTextBox"></asp:RequiredFieldValidator>
             ...
             <br />
                ...
                <div class="col-sm-4">
                    <label>HOD Name</label>
                         ...
                         <div class="col-sm-8">
                    <%--<asp:TextBox ID="DepartmentTextBox" CssClass="form-control bor" Width="100%" Enable="true" placeholder="Department Name" runat="server"></asp:TextBox>--%>
                        <asp:DropDownList ID="DropDownList_HOd" CssClass="form-control bor" Width="100%" Enable="true" runat="server" AutoPostBack="false" AppendDataBoundItems="True">
                        <asp:ListItem>--Select--</asp:ListItem>
                        </asp:DropDownList>                   
                    </div>
                </div>
                 <br />
                       ...
                       <div class="row">
                <div class="col-sm-4">
                    <label>HOD ID</label><br />
                    </div>
                         <div class="col-sm-8">
                    <asp:TextBox ID="txtHodId" CssClass="form-control bor txtHodId" Width="100%" Enable="true" placeholder="HOD ID" runat="server"></asp:TextBox>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="Enter the HOD Id"  ValidationGroup="submit" ForeColor="Red"  ControlToValidate="txtHodId" SetFocusOnError="true"></asp:RequiredFieldValidator>
    ...
    <div class="row">
        ...
        <div class="col-sm-12">
                <div class="peer">
                 <asp:Button ID="Submit" CssClass="form-control bor " Width="100%" ValidationGroup="submit" BorderColor ="DodgerBlue"  runat="server" Text="Submit" OnClick="Submit_Click" />
        ...
        <div class="col-sm-12">
                <div class="peer">
                 <asp:Button ID="Alter" CssClass="form-control bor" ValidationGroup="submit" Width="100%" BorderColor ="DodgerBlue"  runat="server" Text="Alter" OnClick="Alter_Click"  />
   ...
   <%-- <div class="col-sm-2">
        ...
        <div class="col-sm-12">
                <div class="peer">
                 <asp:Button ID="Delete" CssClass="form-control bor " Width="100%" ValidationGroup="submit" BorderColor ="DodgerBlue"  runat="server" Text="Delete" OnClick="Delete_Click"  />
                 </div>
                        <%--<div class="col-sm-2">
            ...
            {   
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        document.getElementById('<%= txtHodId.ClientID %>').value = data.d.Department;
 ...
 <script>
     $(document).ready(function () {
         ...
         $("[id*=DepartmentTextBox]").change(function () {
            // alert("ssss");
             ...
             console.log(ks);
             $.ajax({
                 url: "ManagerList.aspx/MChecking",
                 method: 'post',
                 contentType: "application/json; charset=utf-8",
                 async: true,
                 dataFilter: function (data) { return data; },
                 ...
                 success: function (data) {
                     ...
                     var ddlCustomers = $("[id*=DropDownList_HOd]");
      ...
      <script>
            $(document).ready(function () {
                ...
                $("[id*=DropDownList_HOd]").change(function () {
                    // alert("ssssssssss");
                    console.log("mailtest1");
                    var st = $(this).children("option:selected").val().toString();
                    var res = st.split(',');
                    ...
                    var feids = "";
                    $.ajax({
                        url: 'ManagerList.aspx/MCheckings',
                        method: 'post',
                        contentType: "application/json; charset=utf-8",
                        async: true,
                        dataFilter: function (data) { return data; },
