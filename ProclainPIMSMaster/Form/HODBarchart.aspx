<%@ Page Title="" Language="C#" MasterPageFile="~/HOS.Master" AutoEventWireup="true" CodeBehind="HODBarchart.aspx.cs" Inherits="ProclainPIMSMaster.Form.HODBarchart" %>
...
<script type="text/javascript">                                      				                                        				    
    function bindgraphNew(c, fr, rm, csent) {
        console.log('method called ', c, fr, rm, csent);
        var c = [parseInt(c)];
        var fr = [parseInt(fr)];
        var rm = [parseInt(rm)];
        var csent = [parseInt(csent)];
        ...
        var Config = {
            "graphset": [{
                ...
                "plot": {
                    ...
                    "styles": ["#9966ff", "#000666", "#714d2a", "#1c1c4c"],
                ...
                "scaleX": {
                   ...
                   "New", "From_HR", "From_Manager", "To_HR",
        ...
        zingchart.bind(null, 'node_click', function (e) {
            ...
            swal({
                ...
                if (isConfirm) {
                    if (e.scaletext === "newHos") {
                        console.log("enterbar");
                        newExcel();
                    }


                    else if (e.scaletext === "approvedHos") {
                        console.log("enterbar");
                        approvedHos();
                    }
                    else if (e.scaletext === "totalHos") {
                        console.log("enterbar");
                        totalExcel();
                    }
