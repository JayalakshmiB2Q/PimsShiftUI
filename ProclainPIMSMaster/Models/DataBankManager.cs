...
namespace ProclainPIMSMaster.Models
{
    public class DataBankManager
    {
        ...
        public void ManagerInboxInsert(DataBankManager M)
        {
            ...
            Da.parameters.Add(OP6);
            SqlParameter OP8 = new SqlParameter("@FileUpload3", M.FileUpload3);
        ...
        public void SupervisorInboxInsert(DataBankManager M)
        {
            ...
            Da.ExecuteNonQuery("sp_SupervisorInBox_Insert_FrmDBM");


        }
        public void SupervisorEvaInsert_OtherSend(DataBankManager M)
        {
            ...
            Da.ExecuteNonQuery("sp_Supervisor_send_mail_OtherDepartment");
        ...
        public void ManagerEvaInsert(DataBankManager M)
        {
