...
namespace ProclainPIMSMaster.Models
{
    ...
    public class Employee
    {
        ...
        public DataSet Spsearch(Employee EM)
        {
            ...
            Ds = Da.ExecuteDataset("SP_Supervisor_Search_EmployeeForm");
            return Ds;


        }
        public DataSet SupervisorSelectAll()
        {
            DataTO Da = new DataTO();
            DataSet Ds = new DataSet();
            Ds = Da.ExecuteDataset("SP_Supervisor_Select");
            return Ds;
        ...
        public void SupervisorUpdate(Employee EM)
        {

            DataTO Da = new DataTO();
            SqlParameter OP = new SqlParameter("@SupervisorId", EM.EmployeeId);
            Da.parameters.Add(OP);
            SqlParameter OP0 = new SqlParameter("@SupervisorName", EM.EmployeeName);
            Da.parameters.Add(OP0);
            SqlParameter OP1 = new SqlParameter("@Email", EM.Email);
            Da.parameters.Add(OP1);
            SqlParameter OP2 = new SqlParameter("@DepartmentId", EM.DepartmentId);
            Da.parameters.Add(OP2);
            ...
            Da.ExecuteNonQuery("SP_Supervisor_Update_EmployeeForm");


        }
        public void SupervisorInsert(Employee EM)
        {
            ...
            SqlParameter OP2 = new SqlParameter("@DepartmentId", EM.DepartmentId);
            Da.parameters.Add(OP2);
            SqlParameter OP3 = new SqlParameter("@ManId", EM.ManagerId);
            ...
            Da.ExecuteNonQuery("SP_Supervisor_Insert");
        ...
        public DataSet EmpSelectDashboard_DBM(string year)
        {
            DataTO Da = new DataTO();
            DataSet Ds = new DataSet();
            SqlParameter OP1 = new SqlParameter("@year", year);
            Da.parameters.Add(OP1);
            Ds = Da.ExecuteDataset("[SP_Employee_Dashboard_DBM]");
            return Ds;
        ...
        public DataSet Allcomments(string idea)
        {
            DataTO Da = new DataTO();
            DataSet Ds = new DataSet();
            SqlParameter OP1 = new SqlParameter("@ideaid", idea);
            Da.parameters.Add(OP1);
            Ds = Da.ExecuteDataset("[sp_All_comments]");
            return Ds;
        ...
        public DataSet HODDashboardCount(Employee E)
        {
            DataTO Da = new DataTO();
            DataSet Ds = new DataSet();
            SqlParameter OOP1 = new SqlParameter("@ReceiverID", E.CountReceiverID);
        ...
        public DataSet ManCountDashboard(Employee E)
        {
            DataTO Da = new DataTO();
            DataSet Ds = new DataSet();
            SqlParameter OOP1 = new SqlParameter("@ReceiverID", E.CountReceiverID);
        ...
        public DataSet ImplTeamEvalRepViewReassign(Employee M)
        {
            ...
            SqlParameter OP1 = new SqlParameter("@ReceiverID", M.CMID);
            Da.parameters.Add(OP1);
            Ds = Da.ExecuteDataset("[teammember_mailview_reassign]");
            return Ds;
        ...
        public DataSet depIDAuto(Employee EM)
        {
            DataTO Da = new DataTO();
            DataSet Ds = new DataSet();
            SqlParameter OP1 = new SqlParameter("@ideaid", EM.IdeaID);
            Da.parameters.Add(OP1);
            Ds = Da.ExecuteDataset("sp_IMPLTeam_DepID_AutoGeneration");
            return Ds;
