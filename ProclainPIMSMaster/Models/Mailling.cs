...
namespace ProclainPIMSMaster.Models
{
    public class Mailling
    {
        ...
        public DataSet SupervisorSelectRepeterView(Mailling M)
        {
            DataTO Da = new DataTO();
            DataSet Ds = new DataSet();
            ...
            SqlParameter OP1 = new SqlParameter("@DepId", M.DepId);
            Da.parameters.Add(OP1);
            Ds = Da.ExecuteDataset("Supervisor_mailview");
            return Ds;
        ...
        public DataSet ManagerSelectRepeterViewassigned(Mailling M)
        {
            ...
            SqlParameter OP1 = new SqlParameter("@DepId", M.DepId);
            Da.parameters.Add(OP1);
            Ds = Da.ExecuteDataset("Supervisor_mailview_assigned");
            return Ds;
        ...
        public DataSet ManagerSelectRepeterViewhold(Mailling M)
        {
            ...
            SqlParameter OP1 = new SqlParameter("@DepId", M.DepId);
            Da.parameters.Add(OP1);
            Ds = Da.ExecuteDataset("Supervisor_mailview_hold");
            return Ds;

        }

        public DataSet ManagerSelectRepeterViewFromImpl(Mailling M)
        {
            DataTO Da = new DataTO();
            DataSet Ds = new DataSet();
            ...
            SqlParameter OP1 = new SqlParameter("@DepId", M.DepId);
            Da.parameters.Add(OP1);
            Ds = Da.ExecuteDataset("Resend_to_Impl_team_by_man");
            return Ds;

        }
        public DataSet ManagerIDAuto(Mailling M)
        {
            DataTO Da = new DataTO();
            DataSet Ds = new DataSet();
            ...
            Da.ExecuteNonQuery("sp_ManagerID_AutoGen");
            return Ds;
        ...
        public DataSet ManagerSelectRepeterViewresend_hod(Mailling M)
        {
            DataTO Da = new DataTO();
            DataSet Ds = new DataSet();
            ...
            SqlParameter OP1 = new SqlParameter("@DepId", M.DepId);
            Da.parameters.Add(OP1);
            Ds = Da.ExecuteDataset("[Manager_resendView]");
            return Ds;
    ...
    public DataSet ManagerSelectRepeterViewresendHR(Mailling M)
    {
        DataTO Da = new DataTO();
        DataSet Ds = new DataSet();
        ...
        //SqlParameter OP1 = new SqlParameter("@DepId", M.DepId);
        //Da.parameters.Add(OP1);
        Ds = Da.ExecuteDataset("[Manager_resend_HR_mailview]");
        return Ds;
    ...
    public DataSet Barchart_get_details()
        ...
        public DataSet RepeatersearchSupervisorEval(Mailling M)
        {
            ...
            SqlParameter OP1 = new SqlParameter("@IdeaID", M.IdeaId);
            Da.parameters.Add(OP1);
            Ds = Da.ExecuteDataset("[SP_EmployeeSuggestion_Select_Mailing_IdeaID_Supervisor]");
            return Ds;
