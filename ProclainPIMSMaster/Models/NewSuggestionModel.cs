...
namespace ProclainPIMSMaster.Models
{
    public class NewSuggestionModel
    {
        ...
        private string mangerdepartment;
        public string ManagerDepartmentID
        {
            get { return mangerdepartment; }
            set { mangerdepartment = value; }
        }
        ...
        //public void ManagerInboxInsert(NewSuggestionModel SM)
        //{

        //    DataTO Da = new DataTO();
        //    SqlParameter OP000 = new SqlParameter("@CmEmailID", SM.IEmpId);
        //    Da.parameters.Add(OP000);
        //    SqlParameter OP00 = new SqlParameter("@SendId", SM.IEmpId);
        //    Da.parameters.Add(OP00);
        //    SqlParameter OP7 = new SqlParameter("@SenderID", SM.HEmployeeName);
        //    Da.parameters.Add(OP7);
        //    SqlParameter OP1 = new SqlParameter("@IEmpId", SM.HEmployeeID);
        //    Da.parameters.Add(OP1);
        //    SqlParameter OP = new SqlParameter("@IdeaId", SM.IdeaId);
        //    Da.parameters.Add(OP);
        //    SqlParameter OP11 = new SqlParameter("@From", SM.DBMEmail);
        //    Da.parameters.Add(OP11);
        //    SqlParameter OP2 = new SqlParameter("@EmailId", SM.Email);
        //    Da.parameters.Add(OP2);
        //    SqlParameter OP0 = new SqlParameter("@Date", SM.Date);
        //    Da.parameters.Add(OP0);
        //    SqlParameter OP3 = new SqlParameter("@Subject", SM.Subject);
        //    Da.parameters.Add(OP3);
        //    SqlParameter OP4 = new SqlParameter("@EmailContent", SM.Discription);
        //    Da.parameters.Add(OP4);

        //    SqlParameter OP5 = new SqlParameter("@Remark1", SM.Remark1);
        //    Da.parameters.Add(OP5);
        //    SqlParameter OP6 = new SqlParameter("@Remark3", SM.Remark3);
        ...
        public void SuggestionInsert(NewSuggestionModel SM)
        {
            ...
            SqlParameter OP13 = new SqlParameter("@ManagerDepartment", SM.ManagerDepartmentID);
            Da.parameters.Add(OP13);
            SqlParameter OP14 = new SqlParameter("@Remark2", SM.Remark2);
            Da.parameters.Add(OP14);
            SqlParameter OP15 = new SqlParameter("@Remark3", SM.Remark3);
            Da.parameters.Add(OP15);
            SqlParameter OP16 = new SqlParameter("@Remark4", SM.Remark4);
            Da.parameters.Add(OP16);
